...
res_db_05Hz = load_res("Summarized_data/BCL.2000.ISO.0.CaMKII_inhb.0.CaMKII_db.1_DAD_only_60s.mat");
res_inh_05Hz = load_res("Summarized_data/BCL.2000.ISO.0.CaMKII_inhb.1.CaMKII_db.0_DAD_only_60s.mat");
...
% swarmchart(ones(1,cell_num), [res_inh_05Hz.DAD],36, [31, 119, 180]/250)
% swarmchart(ones(1,cell_num)+1, [res_db_05Hz.DAD],36, [214, 39, 40]/255)

swarmchart(2+ones(1,cell_num), [res_inh_1Hz.DAD],36, [31, 119, 180]/250)
swarmchart(2+ones(1,cell_num)+1, [res_db_1Hz.DAD],36, [214, 39, 40]/255)

swarmchart(4+ones(1,cell_num), [res_inh_2Hz.DAD],36, [31, 119, 180]/250)
swarmchart(4+ones(1,cell_num)+1, [res_db_2Hz.DAD],36, [214, 39, 40]/255)

swarmchart(6+ones(1,cell_num), [res_inh_3Hz.DAD],36, [31, 119, 180]/250)
swarmchart(6+ones(1,cell_num)+1, [res_db_3Hz.DAD],36, [214, 39, 40]/255)
swarmchart(8+ones(1,cell_num), [res_inh_4Hz.DAD],36, [31, 119, 180]/250)
swarmchart(8+ones(1,cell_num)+1, [res_db_4Hz.DAD],36, [214, 39, 40]/255)
...
% swarmchart(ones(1,cell_num), [res_inh_05Hz.DAD_Ca_ratio],36, [31, 119, 180]/250)
% swarmchart(ones(1,cell_num)+1, [res_db_05Hz.DAD_Ca_ratio],36, [214, 39, 40]/255)

swarmchart(2+ones(1,cell_num), [res_inh_1Hz.DAD_Ca_ratio],36, [31, 119, 180]/250)
swarmchart(2+ones(1,cell_num)+1, [res_db_1Hz.DAD_Ca_ratio],36, [214, 39, 40]/255)

swarmchart(4+ones(1,cell_num), [res_inh_2Hz.DAD_Ca_ratio],36, [31, 119, 180]/250)
swarmchart(4+ones(1,cell_num)+1, [res_db_2Hz.DAD_Ca_ratio],36, [214, 39, 40]/255)

swarmchart(6+ones(1,cell_num), [res_inh_3Hz.DAD_Ca_ratio],36, [31, 119, 180]/250)
swarmchart(6+ones(1,cell_num)+1, [res_db_3Hz.DAD_Ca_ratio],36, [214, 39, 40]/255)

swarmchart(8+ones(1,cell_num), [res_inh_4Hz.DAD_Ca_ratio],36, [31, 119, 180]/250)
swarmchart(8+ones(1,cell_num)+1, [res_db_4Hz.DAD_Ca_ratio],36, [214, 39, 40]/255)
...
set(gca,'linewidth',1.5)
	figname = sprintf('F_rate_dep_%d.eps', i);
