function [output] = A0_Obtain_intial_conditions(duration, frequencey, ISO_param, beat_analysis)

%% Parameters for external modules

load y_final.mat
load parameter_matrix_600_trial % sigma 0.1
all_parameters = all_parameters;
[N_trials N_par] = size(all_parameters);

%% Param
AF_index = 0; % 0 = nSR; 1 = AF (AF Model not final)
freq = frequencey;
...
y0n = y_final'; % Comment this once obtained population inital conditions

% parfor ii = 1:N_trials
for ii = 1:10

    %     y0n = all_ICs(ii,:); Can use this once you obtain population inital conditions
...
save ICs_matrix_600_trial all_ICs
