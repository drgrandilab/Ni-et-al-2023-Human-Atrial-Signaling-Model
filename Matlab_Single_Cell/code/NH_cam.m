function [dydt, JCa] = NH_cam(~,y,params)
% This function describes the ODE's for CaM, CaMKII, and CaN

% NH Notes
% params and int conditions should match
% Equations match haibos model
...
PP1tot = params(7);
Ca = params(8);
% cyclelength = params(9);
% compartment = params(10);
...
% CaM Reaction fluxes %maybe not changed between the two models
...
Pi = 1 - Pb2 - Pb - Pt - Pt2 - Pa;  % comment by haibo: pi is thus the remaining 
                                    % proportion of CaMKII occupying Pi;
