...
double LTCC_Markov::update_states_v3_plus(double Caj, double Vm, double najLCC, double kjLCC) {
	int flag_7_state = 1;
	...
	double Tv1  = 60 + 60*exp(-(Vm+50)*(Vm+50)/150);  // 0.15 * 8.91 * (49.008 / (1 + exp((Vm + 2.04 + 28.1273 - 1) / (10.63680 * 0.42)))) * (0.867157776373 / (1 + exp((Vm + 0.6476 + 64) / (-4.69634 * 0.82)))) + 50;// + 60 / (1 + exp((Vm + 70) / (2.0))); //  haibo changed here.
	...
	*/
	...
	Tv1  =  60 + 4000*exp(-(Vm+50)*(Vm+50)/150);//0.5 * 8.91 * (49.008 / (1 + exp((Vm + 2.04 + 28.1273 - 1) / (10.63680 * 0.42)))) * (0.867157776373 / (1 + exp((Vm + 0.6476 + 64) / (-4.69634 * 0.82)))) + 56;// + 60 / (1 + exp((Vm + 70) / (2.0))); //  haibo changed here.
	...
	double Tv1_K5p = 60 + 4000*exp(-(Vm+50)*(Vm+50)/150);//0.5 * 8.91 * (49.008 / (1 + exp((Vm + 2.04 + 28.1273 - 1) / (10.63680 * 0.42)))) * (0.867157776373 / (1 + exp((Vm + 0.6476 + 64) / (-4.69634 * 0.82)))) + 56; ///*+ 60 / (1 + exp((Vm + 70) / (2.0)))*/; //  haibo changed here.
	...
	double tau_k78 = 60 + 60.0 / (1.0 + exp( (Vm + 30)/-3 ));
...
double LTCC_Markov::update_states_v3_plus_mode_2(double Caj, double Vm, double najLCC, double kjLCC) {
	int flag_7_state = 1;
