...
double LTCC_Markov::update_states_v7_BPS_2020(double Caj, double Vm, double najLCC, double kjLCC, double ISO_PKA) {
	...
	// s1o = 0.0182688;   // [1/ms]
	double s1o = /*1.2 * */4.2 * 0.0182688;// *(ISO_PKA*1+1); // [1/ms]  doubled by haibo
	// double k1o = 0.024168;    // [1/ms]
	double k1o = /*1.2 * */4.2 * 0.024168;// *(ISO_PKA*1+1); // [1/ms]  Haibo double here...
...
double LTCC_Markov::update_states_v7_BPS_2020_mode_2(double Caj, double Vm, double najLCC, double kjLCC, double ISO_PKA) {
	double ISO_Shift = ISO_PKA * 3;
	...
	double cat = 7.617e-3;    // [mM]
	// s1o = 0.0182688;   // [1/ms]
	double s1o = /*1.2 * */4.2 * 0.018268;//8*(ISO_PKA*1+1) ; // [1/ms]  doubled by haibo
	// double k1o = 0.024168;    // [1/ms]
	double k1o = /*1.2 * */4.2 * 0.024168;// *(ISO_PKA*1+1); // [1/ms]  Haibo double here...
	// double k1o = s1o;///*1.2 * */3.0 * 0.024168; // [1/ms]  Haibo double here...
	double k2o = 0.000103615; // [1/ms]
