...
folder = './'
files = ['AF.BCL.250.CKII_db.ISO.1/global_result/global_current.txt','AF.CL.250.CKII_inh.ISO.1/global_result/global_current.txt']
...
for ci,f in zip(colors,files):
	...
	#ax.plot(data0[0]+6e4, data0[7], ci,lw= 1.5, alpha=0.2, label='Original')
