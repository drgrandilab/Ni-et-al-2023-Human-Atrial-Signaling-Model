#include <cmath>
#include "LTCC_Markov_M2.hpp"

LTCC_Markov_M2::LTCC_Markov_M2(int NCaL_set, int ID)
    : random_num_LTCC(3, ID)
{
    open_NCaL_num   = 0;
    NCaL = NCaL_set;
...
LTCC_Markov_M2::~LTCC_Markov_M2() {

}

double LTCC_Markov_M2::update_states_v7(double dt, double Caj, double Vm) {
    ...
    // this describes mode 2
    r1 =  3. * R1 / T1;
    r2 =  (1 - 3.0 * R1) / T1; //  * (1.0 + 1.5 / (1 + exp((Vm + 50) / 1)));
