...
folder = './'
files = ['AF.BCL.500.CKII_db.ISO.1/global_result/global_current.txt','AF.CL.500.CKII_inh.ISO.1/global_result/global_current.txt']
files2 = ['AF.BCL.500.CKII_db.ISO.1/global_result/global_cai.txt','AF.CL.500.CKII_inh.ISO.1/global_result/global_cai.txt']
...
plt.savefig('_test_w_ISO.pdf', dpi=300)
